...
if __name__ == '__main__':
    ...
    # isolate binding curve (== singleplex) measurements
    ...
    # fit CV and bg
    p0 = (0.05, 0.001)  # initial guess for fit
    ...
    plt.plot(readouts, variance_estimator(readouts, *popt[0]),
             label=f'$Var=(\mu\cdot {popt[0][0]:.3e})^2+{popt[0][1]:.3e}$')
